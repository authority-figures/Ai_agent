...
import os, sys
# 关键：强制设置Qt平台插件路径为PyQt5的插件路径
# 路径格式：{Python环境路径}/lib/python3.x/site-packages/PyQt5/Qt5/plugins/platforms
# 你的环境路径：/home/lwh/anaconda3/envs/pybullet-py3.10/
qt_platform_path = "/home/lwh/anaconda3/envs/pybullet-py3.10/lib/python3.10/site-packages/PyQt5/Qt5/plugins/platforms"
os.environ["QT_QPA_PLATFORM_PLUGIN_PATH"] = qt_platform_path

# 同时禁用Qt的插件搜索缓存（避免加载旧路径）
